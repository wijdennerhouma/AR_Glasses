   ...
   function ja() {
    console.log("La fonction ja() a été exécutée.");
     ...
     if (Ca.adjust) {
       ...
       Ca.changeModelContainer = document.getElementById("ARLookWidgetChangeModelContainer");
   ...
   function Sb(S) {
    console.log("La fonction Sb(S) a été exécutée.");
     ...
     if (!S && 1 >= ua && 1 >= Ga && 1 === fb.oFactor)
       console.log("INFO in ARLookWidget.resize: resolution difference too small abord resize" );
     else if (
       ((fb.displayWidth = V.width),
       (fb.displayHeight = V.height),
       (fb.oFactor = 1),
       console.log(
         "INFO in ARLookWidget.resize: width = " +
   ...
   var Lb = (function () {
       ...
       function lc(a) {
        console.log("Lb :La fonction lc(a) a été exécutée.");
         ...
         this.m = function () {
          console.log("--------Lb : this.m été exécutée.");
           this.Wk(w.Nc);
           f.Do({ Zd: w.Zd, eg: w.eg, Yd: w.Yd });
         };
         this.cm = function (m) {
          console.log("--------Lb : this.cm été exécutée.");
           return b[m];
         };
         this.te = function (m) {
          console.log("--------Lb : this.te été exécutée.");
         ...
         this.Wk = function (m) {
           ...
           b = m.map(function (u, y) {
            console.log("--------Lb : b=m.map été exécutée.");
             u = Object.assign({}, u, {
               index: y,
               parent: p,
               de: q,
         ...
         this.Aa = function (m) {
          console.log("--------Lb : this.Aa été exécutée.");
           m.h(0);
           var q = m;
           b.forEach(function (x) {
            console.log("--------Lb : b.forEach été exécutée.");
             q = x.Aa(q, !1);
           });
           return q;
         };
         this.ai = function () {
          console.log("--------Lb : this.ai été exécutée.");
           return d.bm();
         };
         this.Fc = function () {
          console.log("--------Lb : this.Fc été exécutée.");
           return f.fm();
         };
         this.Xh = function () {
          console.log("--------Lb : this.Xh été exécutée.");
           return f.Xh();
         };
         this.A = function () {
          console.log("--------Lb : this.A été exécutée.");
           b &&
             ...
             ? (Nb(a, "autoplay"),
               ...
               Fd(f).then(function () {
                 dd(
                   ...
                   function () {
                     function l(w) {
                      console.log("Lb :La fonction l(w) a été exécutée.");
                       if (0 === w.length)
       ...
       function Gd() {
        console.log("Lb :La fonction Gd() a été exécutée.");
         function a(K) {
          console.log("Lb :La fonction a(k) a été exécutée.");
           K = K ? Ac.ff : 1;
           ia.width = K * J.width;
         ...
         function x() {
          console.log("Lb :La fonction x() a été exécutée.");
           ...
           da.set_offset = function (K) {
            console.log("--------Lb : da.set_offset été exécutée.");
             ma = K;
             Ra.ue();
           };
           da.set_scale = function (K) {
            console.log("--------Lb : da.set_scale été exécutée.");
             ya = K;
             Ra.ve();
           };
           da.set_rx = function (K) {
            console.log("--------Lb : da.set_rx été exécutée.");
             qa = K;
             Ra.Yj();
           };
           ...
           da.is_viewer3D = function () {
            console.log("--------Lb : da.is_viewer3D été exécutée.");
             return xa === ra.Ka;
           };
           da.switch_viewer3D = function (K, R) {
            console.log("--------Lb : da.switch_viewer3D été exécutée.");
             if (
               xa === ra.mc ||
               xa === ra.nc ||
               (xa === ra.Y && !K) ||
           ...
           da.capture_image = function (K, R, Z, pa) {
            console.log("--------Lb : da.capture_image été exécutée.");
             Xa.bc = K;
             Xa.isEnabled = !0;
             ...
             L();
             Xa.D = function () {
              console.log("--------Lb : Xa.D été exécutée.");
               Ba.ej(0);
               c.flush();
               var Oa = mb.Zh(Z);
               R(Oa);
           ...
           da.capture_detection = function (K, R) {
            console.log("--------Lb : da.capture_detection été exécutée.");
           ...
           da.process_image = function (K) {
            console.log("--------Lb : da.process_image été exécutée.");
             function R() {
              console.log("Lb : da La fonction R() a été exécutée.");
           ...
           da.process_offlineRendering = function (K, R, Z, pa, Oa) {
            console.log("--------Lb : da.process_offlineRendering été exécutée.");
             Ra.Wn();
             pa &&
           ...
           da.serialize_detection = function (K) {
            console.log("--------Lb : da.serialize_detection été exécutée.");
             return K.cc();
           };
           da.unserialize_detection = function (K, R, Z) {
            console.log("--------Lb : da.unserialize_detection été exécutée.");
             return fd.Zc(K, R, Z);
           };
           da.do_instantDetection = function (K, R) {
            console.log("--------Lb : da.do_instantDetection été exécutée.");
             gd.m(T.pc);
             gd.start(K, R);
           };
           da.relieve_DOM = function (K, R) {
            console.log("--------Lb : da.relieve_DOM été exécutée.");
             if (ka.Wb) return !1;
             k(R || 160);
             Ma.isEnabled = !1;
             N && clearTimeout(N);
           ...
           da.switch_slow = function (K, R) {
            console.log("--------Lb : da.switch_slow été exécutée.");
             if (ka.Wb) return !1;
           ...
           da.switch_sleep = function (K, R) {
            console.log("--------Lb : da.switch_sleep été exécutée.");
             function Z() {
               da.isBusy = !1;
           ...
           da.set_modelStandalone = function (K, R) {
            console.log("-----Lb: da.set_modelStandalone a été exécutée.-------------------");
             Ba.oe(!1);
             Kc.instance({
               ld: q,
               url: K.model,
               ac: K.materials,
               Me: function (Z) {
                console.log("--------------Lb:  Me a été exécutée.-------------------");
                 y(Z);
                 R && R();
                 Ra.Hg();
                 Ba.oe(!0);
           ...
           da.get_partsNames = function () {
            console.log("--------Lb : da.get_partsNames été exécutée.");
             return ab ? ab.sf() : [];
           };
           da.update_material = function (K, R, Z) {
            console.log("--------------------da.update_material a été exécutée.-------------------");
           ...
           da.set_model = function (K, R, Z) {
            console.log("--------------------da.set_model a été exécutée.-------------------");
             ab &&
           ...
           da.update_tweaker = function (K) {
            console.log("--------------------da.update_tweaker a été exécutée.-------------------");
             m(K, !1);
           };
           da.set_tweaker = function (K, R) {
            console.log("--------------------da.set_tweaker a été exécutée.-------------------");
             function Z(pa) {
               m(pa, !0);
               R && R();
             }
           ...
           da.get_tweaker = function () {
            console.log("--------------------da.get_tweaker a été exécutée.-------------------");
             return {
               preOffset: tb,
               preScale: Ub,
               rx: t,
           ...
           da.get_materialsSpec = function () {
            console.log("--------------------da.get_materialsSpec a été exécutée.-------------------");
             return ab ? ab.di() : Promise.reject("NOT_READY");
           };
           da.set_materials = function (K, R) {
            console.log("--------------------da.set_materials a été exécutée.-------------------");
             if (ab) {
               var Z = b([J.ea, J.wa, J.Vd + "/"]);
               K = K.map(function (pa) {
                 var Oa = pa;
           ...
           da.replace_material = function (K, R) {
            console.log("--------------------da.replace_material a été exécutée.-------------------");
             if (ab)
         ...
         function I() {
          console.log("Lb  : La fonction I() a été exécutée.");
           ha.Xg(Ac.Ll);
           Ra.Yc();
         ...
         function u() {
          console.log("Lb  :  La fonction u() a été exécutée.");
           Ob.reset();
           Db.stop();
           Ea.ba();
           g(0);
         ...
         function y(K) {
          console.log("Lb : La fonction y(K) a été exécutée.");
           ab && (Ba.Nn(ab), ab.remove());
           Ba.lk(K);
           ab = K;
         }
         function A() {
          console.log("Lb:  La fonction A() a été exécutée.");
           tb = [0, 0, 0];
           Ub = 1;
           Vb = v = t = 0;
           Wb = J.Oc;
         ...
         function k(K) {
          console.log("Lb : La fonction k(K) a été exécutée.");
           r = K;
           Db.update({ Ca: r });
         }
         function g(K) {
          console.log("Lb : La fonction g(K) a été exécutée.");
           Ma.Bb = -1;
         ...
         function F() {
          console.log("Lb : La fonction F() a été exécutée.");
           ta = Jc.mf();
           Ma.isEnabled = !0;
         }
         function L() {
          console.log("Lb : La fonction L() a été exécutée.");
           var K = 15;
           if (!Fa.Md) {
         ...
         function D() {
          console.log("Lb : La fonction D() a été exécutée.");
           la.bk = ba.instance({
             isPot: !0,
             isLinear: !0,
             isFloat: !1,
         ...
         function G() {
          console.log("Lb : La fonction G() a été exécutée.");
           function K() {
            console.log("Lb : La fonction K() a été exécutée.");
             return {
               width: 3,
               height: 1,
               isFloat: !0,
         ...
         function e(K) {
          console.log("Lb : La fonction e(K) a été exécutée.");
           la.mg = K;
           if (Ha) {
             Ha = !1;
             aa.set("s70");
         ...
         function n() {
          console.log("Lb : La fonction n() a été exécutée.");
           Da.Fi = ta;
           Da.be.J();
           aa.set(H.wi ? "s73" : "s72");
           la.mg.h(0);
         ...
         function P(K) {
          console.log("Lb : La fonction P(K) a été exécutée.");
           a(K);
           K = J.width;
           var R = J.height;
           Q.ob[0] = 1;
         ...
         function B() {
          console.log("Lb : La fonction B() a été exécutée.");
           aa.j("s64", [
         ...
         var ma = [0, 0, 0],
           ...
           Ra = {
             m: function () {
              console.log("Lb: ----------------m a été exécutée.-------------------");
               aa.uc([
                 {
                   id: "s62",
                   name: "_",
               ...
               da.set_LUT = function (K) {
                console.log("Lb : --------------da.set_LUT a été exécutée.-------------------");
               ...
               da.resize = function (K, R, Z, pa) {
                console.log("Lb : ----------------da.resize a été exécutée.-------------------");
                 da.ready &&
                   (ka.hb && (clearTimeout(ka.hb), (ka.hb = null)),
                   Db.stop(),
                   (Z = Z ? Ac.ff : 1),
             ...
             Nl: E,
             Ko: function () {
              console.log("Lb: ----------------ko a été exécutée.-------------------");
               D();
               P(!0);
               B();
               Ra.Kj();
             ...
             gm: function () {
              console.log("Lb: --------------------gm a été exécutée.-------------------");

               return ia;
             },
             A: function () {
              console.log("Lb: --------------------A a été exécutée.-------------------");
             ...
             Yc: function () {
              console.log("Lb : --------------------Yc a été exécutée.-------------------");
               Ba.qj(T.pc, null === la.Kb ? la.kb : la.$c, Da.be, la.bk);
             },
             em: function () {
              console.log("Lb: --------------------em a été exécutée.-------------------");
               return nb;
             },
             yj: function (K) {
              console.log("Lb: --------------------yj a été exécutée.-------------------");
               nb = K;
             },
             ue: function () {
              console.log("Lb: --------------------ue a été exécutée.-------------------");
             ...
             ve: function () {
              console.log("Lb: --------------------ve a été exécutée.-------------------");
             ...
             Uo: function () {
              console.log("Lb: --------------------Uo a été exécutée.-------------------");
               Ba.ao(J.gd + v, J.Mb + Vb);
             },
             Wo: function () {
              console.log("Lb : --------------------Wo a été exécutée.-------------------");
               Ba.bo(Wb);
             },
             we: function () {
              console.log("Lb: --------------------We a été exécutée.-------------------");
               Ra.ue();
               Ra.ve();
               Ra.Yj();
               Ra.Uo();
             ...
             Wn: function () {
              console.log("Lb : --------------------Wn a été exécutée.-------------------");
               Db.stop();
               Ab && (clearInterval(Ab), (Ab = null));
               lb.isEnabled = !0;
               lb.bc = 0;
             ...
             Tn: function (K) {
              console.log("Lb : --------------------Tn a été exécutée.-------------------");
               function R() {
                console.log("--------Lb : R() été exécutée.");
                 2 === ++Z &&
                   ((lb.isEnabled = !1),
                   (Ub = ea),
                   (tb = sc),
             ...
             Kj: function () {
              console.log("Lb : --------------------Kj a été exécutée.-------------------");
             ...
             el: function () {
              console.log("Lb : --------------------el a été exécutée.-------------------");
               var K = cb.Ee,
                 R = cb.De,
             ...
             Eg: function (K, R) {
              console.log("Lb : --------------------Eg a été exécutée.-------------------");
               X = [0.5, 0.5];
               K = R / K;
               R = mb.$() / mb.P();
             ...
             Lg: function () {
              console.log("Lb : --------------------Lg a été exécutée.-------------------");
               aa.j("s62", [
                 { type: "1i", name: "u1", value: 0 },
             ...
             Cf: function (K, R) {
              console.log("Lb: --------------------Cf a été exécutée.-------------------");
               return Va
                 ? Promise.resolve()
             ...
             ym: function (K, R) {
              console.log("Lb :--------------------ym a été exécutée.-------------------");
             ...
             oi: function () {
              console.log("Lb : --------------------oi a été exécutée.-------------------");
             ...
             zm: function () {
              console.log("Lb : --------------------zm a été exécutée.-------------------");
               return new Promise(function (K, R) {
                 ha.m({
                   Id: !1,
                   cl: !1,
                   ...
                   Rb: mb,
                   onload: function () {
                    console.log("Lb : --------------------onload a été exécutée.-------------------");
                     Da.Hb = pc.instance({
                       Lb: J.ea + J.wa + db.fp,
                       wc: J.ea + J.wa + db.gp,
                       vc: db.ck,
             ...
             Hg: function () {
              console.log("Lb : --------------------Hg a été exécutée.-------------------");
               Ta || ((Ta = !0), Ra.we(), I(), (ta = 0), J.Lc && u());
             },
             Hi: function (K, R) {
              console.log("Lb : --------------------Hi a été exécutée.-------------------");
               K = Kc.instance({
                 Me: function () {
                  console.log("Lb : --------------------Me a été exécutée.-------------------");
                   Ra.Hg();
             ...
             Lj: function () {
              console.log("Lb: --------------------Lj a été exécutée.-------------------");
               if (J.Zb) {
       ...
       function Kd(a) {
        console.log("Lb : La fonction Kd(a) a été exécutée.");
       ...
       function id(a) {
        console.log("Lb :La fonction id(a) a été exécutée.");
         if (!a) {
           a = J.ea;
       ...
       function kd() {
        console.log("Lb : La fonction kd() a été exécutée.");
       ...
       function ld(a) {
        console.log("Lb :La fonction ld(a) a été exécutée.");
         Fa.element = a;
       ...
       function Ld() {
        console.log("Lb : La fonction Ld() a été exécutée.");
       ...
       function dc(a) {
        console.log("Lb : La fonction dc(a) a été exécutée.");
         return 3 === arguments.length ? this.rb(arguments) : this.set(a);
       }
       function md(a, b) {
        console.log("Lb: La fonction md(a, b) a été exécutée.");
         b = Math.floor(b);
         a.r = ((b >> 16) & 255) / 255;
         a.Z = ((b >> 8) & 255) / 255;
         a.b = (b & 255) / 255;
       ...
       function Ec(a, b, d, f) {
        console.log("Lb: La fonction Ec(a, b, d, f) a été exécutée.");
         this.F = a || 0;
         this.G = b || 0;
         this.H = d || 0;
         this.T = void 0 !== f ? f : 1;
       ...
       function nd(a, b, d) {
        console.log("Lb : La fonction nd(a, b, d) a été exécutée.");
         var f = b.F,
           l = b.G,
           p = b.H;
         b = b.T;
       ...
       function ec(a, b) {
        console.log("Lb : La fonction ec(a, b) a été exécutée.");
         this.x = a || 0;
         this.y = b || 0;
       }
       function Za(a, b, d) {
        console.log("Lb : La fonction Za(a, b, d) a été exécutée.");
         this.x = a || 0;
         this.y = b || 0;
         this.z = d || 0;
       }
       function od(a, b) {
        console.log("Lb : La fonction od(a, b) a été exécutée.");
         var d = a.x,
           f = a.y,
           l = a.z;
         a.x = f * b.z - l * b.y;
       ...
       function fc(a, b, d, f) {
        console.log("Lb : La fonction fc(a, b, d, f) a été exécutée.");
         this.F = a || 0;
         this.G = b || 0;
         this.H = d || 0;
         this.Sa = f || fc.fk;
       ...
       function gc() {
        console.log("Lb : La fonction gc() a été exécutée.");
       ...
       function pd(a, b, d) {
        console.log("Lb : La fonction pd(a, b, d) a été exécutée.");
         var f = b.elements,
           l = d.elements;
         d = a.elements;
         b = f[0];
       ...
       function Qc(a, b, d, f, l, p) {
        console.log("Lb : La fonction Oc(a, b, d, f, l, p) a été exécutée.");
         this.a = a;
         this.b = b;
         this.c = d;
       ...
       function Rc(a, b, d) {
        console.log("Lb : La fonction Rc(a, b, d) a été exécutée.");
         "object" === typeof a ? b(a) : Pd(a, b, d);
       }
       function Qd(a) {
        console.log("Lb : La fonction Qd(a) a été exécutée.");
         return new Promise(function (b, d) {
           Rc(a, b, d);
         });
       }
       function Rd(a, b) {
        console.log("Lb : La fonction Rd(a, b) a été exécutée.");
       ...
       function Sd(a, b) {
        console.log("Lb : La fonction Ds(a, b) a été exécutée.");
       ...
       function Td(a, b, d, f) {
        console.log("Lb : La fonction Td(a, b, d, f) a été exécutée.");
         function l(n) {
          console.log("Lb : La fonction l(n) a été exécutée.");
           G.N(b[n]);
           e.N(G);
           var z = h[n];
           L.N(z);
       ...
       function qd(a, b, d, f) {
        console.log("Lb : La fonction qd(a, b, d, f) a été exécutée.");
       ...
       var W = {
         ...
         aa = (function () {
           function a(t, v, Q) {
            console.log("Lb : aa --------------------a(t, v, Q) a été exécutée.-------------------");
             v = t.createShader(v);
             t.shaderSource(v, Q);
             t.compileShader(v);
           ...
           function b(t, v, Q) {
            console.log("Lb: ------------------------------------------------La fonction b(t, v, Q) a été exécutée.");
           ...
           function d(t) {
            console.log("Lb :La fonction d(t) a été exécutée.");
           ...
           function f(t, v) {
            console.log("Lb: La fonction f(t, v) a été exécutée.");
             v.R = v.R ? !0 : !1;
             if (!v.R) {
               v.v =
                 v.v ||
           ...
           function l(t) {
            console.log("Lb: La fonction l(t) a été exécutée.");
             Cb.Cj(M);
             m !== t.id &&
               (M.M(),
               (m = t.id),
           ...
           function p(t, v, Q) {
            console.log("Lb: La fonction p(t, v, Q) a été exécutée.");
             f(t, v, Q);
             t.useProgram(v.qa);
           ...
           function w() {
            console.log("Lb: La fonction w() a été exécutée.");
             return {
               g: "uniform sampler2D u1;varying vec2 vv0;void main(){gl_FragColor=texture2D(u1,vv0);}",
               i: ["u1"],
               o: { u1: 0 },
           ...
           var h = [],
             ...
             M = {
               zb: function () {
                console.log("Lb:--------------------zb a été exécutée.-------------------");
                 return I;
               },
               m: function () {
                console.log("Lb: --------------------m a été exécutée.-------------------");
               ...
               uc: function (t) {
                console.log("Lb :--------------------uc a été exécutée.-------------------");
                 t.forEach(function (v) {
                   M.oa(v);
                 });
               },
               oa: function (t) {
                console.log("LB : --------------------oa a été exécutée.-------------------");
                 B[t.id] = t;
                 f(c, t, t.id);
               },
               Cm: function (t, v, Q) {
                console.log("Lb: --------------------Cm a été exécutée.-------------------");
                 v || (v = t);
               ...
               set: function (t) {
                console.log("Lb: --------------------set a été exécutée.-------------------");
                 var v = B[t];
                 v.R && ((v.R = !1), f(c, v, t));
                 l(v);
               },
               Eb: function (t) {
                console.log("Lb: --------------------Eb a été exécutée.-------------------");
                 return p(t, w(), "s48");
               },
               he: function (t) {
                console.log("Lb: --------------------he a été exécutée.-------------------");
                 return p(
                   t,
                   {
               ...
               Kl: function (t) {
                console.log("Lb----: ----------------Kl a été exécutée.-------------------");
               ...
               je: function () {
                console.log("Lb: --------------------je a été exécutée.-------------------");
                 var t = 0;
               ...
               Il: function () {
                console.log("Lb : --------------------Il a été exécutée.-------------------");
                 c.enableVertexAttribArray(0);
               },
               fc: function () {
                console.log("Lb : --------------------fc a été exécutée.-------------------");
                 M.hc(c);
               },
               hc: function (t) {
                console.log("Lb : --------------------hc a été exécutée.-------------------");
                 t.vertexAttribPointer(q.xa[0], 2, t.FLOAT, !1, 8, 0);
               },
               ie: function (t, v) {
                console.log("Lb : --------------------ie a été exécutée.-------------------");
                 c.uniform1i(q.B[t], v);
               },
               C: function (t, v) {
                console.log("Lb: --------------------C a été exécutée.-------------------");
                 c.uniform1f(q.B[t], v);
               },
               O: function (t, v, Q) {
                console.log("Lb: --------------------O a été exécutée.-------------------");
                 c.uniform2f(q.B[t], v, Q);
               },
               Bg: function (t, v) {
                console.log("Lb : --------------------Bg a été exécutée.-------------------");
                 c.uniform2fv(q.B[t], v);
               },
               Dg: function (t, v) {
                console.log("Lb: --------------------Dg a été exécutée.-------------------");
                 c.uniform3fv(q.B[t], v);
               },
               Cg: function (t, v, Q, X) {
                console.log("Lb :--------------------Cg a été exécutée.-------------------");
                 c.uniform3f(q.B[t], v, Q, X);
               },
               zo: function (t, v, Q, X, U) {
                console.log("Lb: --------------------zo a été exécutée.-------------------");
                 c.uniform4f(q.B[t], v, Q, X, U);
               },
               Ba: function (t, v) {
                console.log("Lb: --------------------Ba a été exécutée.-------------------");
                 c.uniform4fv(q.B[t], v);
               },
               Ao: function (t, v) {
                console.log("Lb : --------------------Ao a été exécutée.-------------------");
                 c.uniformMatrix2fv(q.B[t], !1, v);
               },
               Bo: function (t, v) {
                console.log("Lb: --------------------Bo a été exécutée.-------------------");
                 c.uniformMatrix3fv(q.B[t], !1, v);
               },
               Vc: function (t, v) {
                console.log("Lb: --------------------Vc a été exécutée.-------------------");
                 c.uniformMatrix4fv(q.B[t], !1, v);
               },
               j: function (t, v) {
                console.log("--------------------j a été exécutée.-------------------");
                 M.set(t);
               ...
               $p: function () {
                console.log("Lb : --------------------$p a été exécutée.-------------------");
                 return "lowp";
               },
               A: function () {
                console.log("Lb : --------------------A a été exécutée.-------------------");
         ...
         c = null,
         mb = (function () {
          console.log("--------Lb : mb: été exécutée.");
           function a(y) {
            console.log("Lb mb :La fonction a(y) a été exécutée.");
           ...
           function d(y, A, k) {
            console.log("Lb : La fonction d(y,A,k) a été exécutée.");
             y.setAttribute("width", A);
             y.setAttribute("height", k);
           }
           function f(y) {
            console.log("Lb : La fonction f(y) a été exécutée.");
             if (b()) return !1;
             var A = document.createElement("canvas");
             d(A, 5, 5);
             var k = null;
           ...
           function l(y) {
            console.log("Lb: La fonction l(y) a été exécutée.");
           ...
           var p = null,
             ...
             u = {
               ...
               $: function () {
                console.log("Lb: --------------------$: a été exécutée.-------------------");
                 return p.height;
               },
               tb: function () {
                console.log("Lb: --------------------tb: a été exécutée.-------------------");
                 return p;
               },
               Ql: function () {
                console.log("Lb: --------------------Ql: a été exécutée.-------------------");
                 return c;
               },
               na: function () {
                console.log("Lb: --------------------na: a été exécutée.-------------------");
                 return m;
               },
               flush: function () {
                console.log("Lb: --------------------flush: a été exécutée.-------------------");
                 c.flush();
               },
               iq: function () {
                console.log("Lb: --------------------iq: a été exécutée.-------------------");
                 Ea.reset();
                 Ea.ba();
                 u.Rn();
               },
               Rn: function () {
                console.log("Lb: --------------------Rn: a été exécutée.-------------------");
                 ba.reset();
                 Y.reset();
                 aa.M();
                 aa.Il();
               ...
               Vl: function () {
                console.log("Lb: --------------------Vl: a été exécutée.-------------------");
               ...
               Wp: function () {
                console.log("Lb:--------------------Wp: a été exécutée.-------------------");
                 return p.toDataURL("image/jpeg");
               },
               Xp: function () {
                console.log("Lb: --------------------Xp: a été exécutée.-------------------");
                 Ea.aa();
                 w ||
               ...
               Zh: function (y) {
                console.log("Lb:--------------------Zh: a été exécutée.-------------------");
                 !w &&
                   y &&
                   ((w = document.createElement("canvas")),
                   (h = w.getContext("2d")));
               ...
               m: function (y) {
                console.log("Lb:--------------------m: function (y) a été exécutée.-------------------");
                 y = Object.assign(
                   {
                     Xa: null,
                     dg: null,
               ...
               zp: function () {
                console.log("Lb: --------------------zp: a été exécutée.-------------------");
         ...
         Cb = (function () {
           ...
           return {
             reset: function () {
              console.log("Lb: --------------------reset: a été exécutée.-------------------");
               b = null;
             },
             Cj: function (d) {
              console.log("Lb: --------------------Cj: a été exécutée.-------------------");
               b !== d && (b && b.M(), (b = d));
             },
             zb: function () {
              console.log("Lb:--------------------zb: a été exécutée.-------------------");
         ...
         ba = (function () {
           function a(E) {
            console.log("Lb:La fonction a(E) a été exécutée.");
             c.bindTexture(c.TEXTURE_2D, E);
           }
           function b(E) {
            console.log("Lb:La fonction b(E) a été exécutée.");
           ...
           function f(E, M) {
            console.log("Lb: La fonction f(E,M) a été exécutée.");
           ...
           var l = 0,
             ...
             B = {
               ...
               po: function () {
                console.log("Lb: --------------------po a été exécutée.-------------------");
                 c.texParameteri(c.TEXTURE_2D, c.TEXTURE_MAG_FILTER, c.LINEAR);
                 c.texParameteri(c.TEXTURE_2D, c.TEXTURE_MIN_FILTER, c.LINEAR);
               },
               so: function () {
                console.log("Lb: --------------------so a été exécutée.-------------------");
                 c.texParameteri(c.TEXTURE_2D, c.TEXTURE_MAG_FILTER, c.NEAREST);
                 c.texParameteri(c.TEXTURE_2D, c.TEXTURE_MIN_FILTER, c.NEAREST);
               },
               Am: function () {
                console.log("Lb: --------------------Am a été exécutée.-------------------");
                 if (!m) {
               ...
               xj: function (E) {
                console.log("Lb: --------------------xj a été exécutée.-------------------");
               ...
               ii: function () {
                console.log("Lb: --------------------ii a été exécutée.-------------------");
                 return m.Sj;
               },
               Vo: function () {
                console.log("Lb: --------------------vo a été exécutée.-------------------");
                 x[1] = Ia.pf(c);
               },
               uo: function () {
                console.log("Lb: --------------------uo a été exécutée.-------------------");
               ...
               fj: function (E) {
                console.log("Lb: --------------------fj a été exécutée.-------------------");
                 aa.set("s1");
                 Ea.aa();
                 var M = E.P(),
                   t = E.$();
               ...
               Aq: function (E, M) {
                console.log("Lb: --------------------Aq a été exécutée.-------------------");
                 B.fj(E);
                 c.readPixels(0, 0, E.P(), E.$(), c.RGBA, c.UNSIGNED_BYTE, M);
               },
               Bq: function (E, M) {
                console.log("Lb: --------------------Bq a été exécutée.-------------------");
                 B.fj(E);
                 return Ia.og(0, 0, E.P(), E.$(), M);
               },
               Th: function (E, M, t, v, Q, X, U) {
                console.log("Lb: --------------------Th a été exécutée.-------------------");
               ...
               Fe: function (E) {
                console.log("Lb: --------------------Fe a été exécutée.-------------------");
                 E !== l && (c.activeTexture(p[E]), (l = E));
               },
               instance: function (E) {
                console.log("Lb: --------------------instance a été exécutée.-------------------");
                 function M() {
                  console.log("Lb: instance:La fonction M() a été exécutée.");
                   qa =
                 ...
                 function t(ea) {
                  console.log("Lb: La fonction t(ea) a été exécutée.");
                   var Aa = c.getError();
                 ...
                 function v() {
                  console.log("Lb: La fonction v() a été exécutée.");
                   if (!T) {
                     a(fa);
                 ...
                 function Q() {
                  console.log("Lb: La fonction Q() a été exécutée.");
                   for (
                 ...
                 var Ya = {
                   get: function () {
                    console.log("Lb: --------------------get a été exécutée.-------------------");
                     return fa;
                   },
                   P: function () {
                    console.log("Lb: --------------------P a été exécutée.-------------------");
                   ...
                   tm: function () {
                    console.log("Lb: --------------------tm a été exécutée.-------------------");
                     return O.url;
                   },
                   Sm: function () {
                    console.log("Lb: --------------------Sm a été exécutée.-------------------");
                     return O.isFloat;
                   },
                   oq: function () {
                    console.log("Lb: --------------------oq a été exécutée.-------------------");
                     return O.U;
                   },
                   Nq: function (ea) {
                    console.log("Lb: --------------------Nq a été exécutée.-------------------");
                     fa = ea;
                   },
                   qq: function () {
                    console.log("Lb: --------------------qq a été exécutée.-------------------");
                     return O.isLinear;
                   },
                   Ec: function () {
                    console.log("Lb: --------------------Ec a été exécutée.-------------------");
                     c.generateMipmap(c.TEXTURE_2D);
                   },
                   Sk: function (ea, Aa) {
                    console.log("Lb: --------------------Sk a été exécutée.-------------------");
                     ub
                       ? (ea || (ea = Ya.fi()),
                         B.Fe(Aa),
                         a(Xa[ea]),
                    ...
                    console.log("Lb: --------------------fi: a été exécutée.-------------------");
                     -1 === lb && (lb = Math.log2(qa));
                     return lb;
                   },
                   zj: function (ea) {
                    console.log("Lb: --------------------zj: a été exécutée.-------------------");
                     c.TEXTURE_MAX_LEVEL &&
                       c.texParameteri(c.TEXTURE_2D, c.TEXTURE_MAX_LEVEL, ea);
                   },
                   Pl: function (ea) {
                    console.log("Lb: --------------------Pl: a été exécutée.-------------------");
                     ea || (ea = Ya.fi());
                     if (ub) {
                       aa.set("s12");
                       B.Fe(0);
                   ...
                   h: function (ea) {
                    console.log("Lb: --------------------h: a été exécutée.-------------------");
                     if (!la) return !1;
                     B.Fe(ea);
                     if (h[ea] === ka) return !1;
                     a(fa);
                   ...
                   ya: function (ea) {
                    console.log("Lb: --------------------ya: a été exécutée.-------------------");
                   ...
                   u: function () {
                    console.log("Lb: --------------------u: a été exécutée.-------------------");
                     q = Ya;
                     B.xj(fa);
                   },
                   J: function () {
                    console.log("Lb: --------------------J: a été exécutée.-------------------");
                   ...
                   se: B.se,
                   mo: function (ea, Aa) {
                    console.log("Lb: --------------------mo: a été exécutée.-------------------");
                     qa = ea;
                     oa = Aa;
                   },
                   resize: function (ea, Aa) {
                    console.log("Lb: --------------------resize: a été exécutée.-------------------");
                     Ya.mo(ea, Aa);
                     v();
                   },
                   clone: function (ea) {
                    console.log("Lb: --------------------clone: a été exécutée.-------------------");
                     ea = B.instance({
                       width: qa,
                       height: oa,
                       U: O.U,
                   ...
                   Wc: function () {
                    console.log("Lb: --------------------Wc: a été exécutée.-------------------");
                     c.viewport(0, 0, qa, oa);
                   },
                   remove: function () {
                    console.log("Lb: --------------------remove: a été exécutée.-------------------");
                     c.deleteTexture(fa);
                     T = !0;
                   ...
                   refresh: function () {
                    console.log("Lb: --------------------refresh: a été exécutée.-------------------");
                     Ya.ya(0);
                   ...
                   dj: function () {
                    console.log("Lb: --------------------dj: a été exécutée.-------------------");
                     ta || X();
                   ...
                   Hn: function () {
                    console.log("Lb: --------------------Hn: a été exécutée.-------------------");
                     ta || X();
                   ...
                   Jn: function () {
                    console.log("Lb: --------------------Jn: a été exécutée.-------------------");
                     cc || U();
                     c.readPixels(0, 0, qa, oa, c.RGBA, c.UNSIGNED_BYTE, ia);
                     return rc;
                   },
                   In: function () {
                    console.log("Lb: --------------------In: a été exécutée.-------------------");
                     cc || U();
                     return Ia.og(0, 0, qa, oa, ia);
                   },
                   Fh: function (ea) {
                    console.log("Lb: --------------------Fh: a été exécutée.-------------------");
                     Ea.aa();
                     aa.set("s15");
                     Ya.h(0);
                     if (ea)
                   ...
                   Wg: function (ea) {
                    console.log("Lb: --------------------Wg: a été exécutée.-------------------");
                     var Aa;
                     if ((Aa = ra === x[0]))
                       null !== P.Bf
                         ? (Aa = P.Bf)
                   ...
                   br: function (ea, Aa) {
                    console.log("Lb:--------------------br: a été exécutée.-------------------");
                     a(fa);
                   ...
                   cc: function (ea, Aa) {
                    console.log("Lb: --------------------cc :a été exécutée.-------------------");
                     var hb = qa * oa,
                       Na = 4 * hb;
                 ...
                 if (O.url)
                   ...
                   var sc = function () {
                    console.log("--------Lb : sc été exécutée.");
                     M();
               ...
               aa: function (E) {
                console.log("--Lb:  ------------------aa a été exécutée.-------------------");
                 E !== l && (c.activeTexture(p[E]), (l = E));
                 h[E] = -1;
                 a(null);
               },
               Uk: function (E) {
                console.log("----Lb:  ----------------Uk a été exécutée.-------------------");
                 m.random.h(E);
               },
               se: function () {
                console.log("---Lb: -----------------se a été exécutée.-------------------");
                 q = null;
                 c.framebufferTexture2D(
                   Ea.qf(),
                   c.COLOR_ATTACHMENT0,
               ...
               Eq: function () {
                console.log("--Lb:  ------------------Eq a été exécutée.-------------------");
                 l = -1;
               },
               Uj: function () {
                console.log("--Lb:  ------------------Uj a été exécutée.-------------------");
                 for (var E = 0; E < p.length; ++E) B.aa(E);
               },
               I: function () {
                console.log("--Lb:------------------I a été exécutée.-------------------");
                 m && (m.random.remove(), m.Sj.remove());

               },
               Zc: function (E, M) {
                console.log("----Lb:  ----------------Zc a été exécutée.-------------------");
         ...
         Mc = {
           instance: function (a) {
            console.log("---Lb:-----------------Mc: instance a été exécutée.-------------------");
             var b = [ba.instance(a), ba.instance(a)],
               d = [b[1], b[0]],
               f = d,
               l = {
                 sj: function (p) {
                  console.log("--------Lb :instance sj été exécutée.");
                   f[1].u();
                   f[0].h(p);
                   l.Gj();
                 },
                 tj: function (p) {
                  console.log("--------Lb :instance tj été exécutée.");
                   f[1].J();
                   f[0].h(p);
                   l.Gj();
                 },
                 Gj: function () {
                  console.log("--------Lb :instance Gj été exécutée.");
                   f = f === b ? d : b;
                 },
                 refresh: function () {
                  console.log("--------Lb :instance refresh été exécutée.");
                   f[0].refresh();
                   f[1].refresh();
                 },
                 h: function (p) {
                  console.log("--------Lb :instance h été exécutée.");
                   f[0].h(p);
                 },
                 ya: function (p) {
                  console.log("--------Lb :instance ya été exécutée.");
                   f[0].ya(p);
                 },
                 Tk: function (p) {
                  console.log("--------Lb :instance TK été exécutée.");
                   f[1].h(p);
                 },
                 bi: function () {
                  console.log("--------Lb :instance bi été exécutée.");
                   return f[0];
                 },
                 bq: function () {
                  console.log("--------Lb :instance bq été exécutée.");
                   return f[1];
                 },
                 Wg: function (p) {
                  console.log("--------Lb :instance wg été exécutée.");
                   f[0].Wg(p);
                   f[1].Wg(p);
                 },
                 remove: function () {
                  console.log("--------Lb :instance remove été exécutée.");
                   f[0].remove();
                   f[1].remove();
                   f = null;
                 },
         ...
         Y = (function () {
           function a(m) {
            console.log("Lb:  La fonction Y= a(m) a été exécutée.");
           ...
           var b = null,
             ...
             h = {
               reset: function () {
                console.log("--------Lb :h reset été exécutée.");
                 w = p = -2;
               },
               m: function () {
                console.log("--------Lb :h m été exécutée.");
                 f || ((b = a(c)), h.kd(), (f = !0));
               },
               instance: function (m) {
                console.log("--------Lb :h instance été exécutée.");
                 var q = d++,
                 ...
                 var F = {
                   yc: function (L) {
                    console.log("--------Lb :h : F yc été exécutée.");
                     p !== q && (c.bindBuffer(c.ARRAY_BUFFER, u), (p = q));
                     L && Cb.je();
                   },
                   Qk: function () {
                    console.log("--------Lb :h : F Qk été exécutée.");
                     w !== q &&
                       (c.bindBuffer(c.ELEMENT_ARRAY_BUFFER, y), (w = q));
                   },
                   bind: function (L) {
                    console.log("--------Lb :h : F bind été exécutée.");
                     F.yc(L);
                     F.Qk();
                   },
                   W: function () {
                    console.log("--------Lb :h : F W été exécutée.");
                     c.drawElements(c.TRIANGLES, x, A, 0);
                   },
                   Na: function (L, D) {
                    console.log("--------Lb :h : F Na été exécutée.");
                     c.drawElements(c.TRIANGLES, L, A, D * k);
                   },
                   remove: function () {
                    console.log("--------Lb :h : F remove été exécutée.");
                     c.deleteBuffer(u);
               ...
               I: function () {
                console.log("--------Lb :h : I été exécutée.");
                 var m = c,
                   q = b;
                 m.deleteBuffer(q.ka);
                 m.deleteBuffer(q.indices);
         ...
         Ea = (function () {
           var a = null,
             ...
             w = {
               ...
               m: function () {
                console.log("--------Lb :Ea : m été exécutée.");
                 if (!f) {
               ...
               Xl: function () {
                console.log("--------Lb :Xl été exécutée.");
                 return b;
               },
               $h: function () {
                console.log("--------Lb :$h été exécutée.");
                 return d;
               },
               qf: function () {
                console.log("--------Lb :qf été exécutée.");
                 return c.FRAMEBUFFER;
               },
               cq: function () {
                console.log("--------Lb :cq été exécutée.");
                 return p;
               },
               Tp: function () {
                console.log("--------Lb :Tp été exécutée.");
                 return a;
               },
               instance: function (h) {
                console.log("--------Lb :instance été exécutée.");
                 void 0 === h.Hc && (h.Hc = !1);
                 var m = h.V ? h.V : null,
                   q = h.width,
                 ...
                 var g = {
                   mj: function () {
                    console.log("--------Lb :instance: mj été exécutée.");
                     y || ((I = c.createFramebuffer()), (y = !0), (k = p.Sh++));
                   },
                   ed: function () {
                    console.log("--------Lb :instance : ed été exécutée.");
                     g.mj();
                     g.u();
                   ...
                   bind: function (F, L) {
                    console.log("--------Lb :bind été exécutée.");
                   ...
                   mh: function () {
                    console.log("--------Lb :mh été exécutée.");
                     k !== p.ma && (c.bindFramebuffer(b, I), (p.ma = k));
                   },
                   clear: function () {
                    console.log("--------Lb :clear été exécutée.");
                     c.clear(c.COLOR_BUFFER_BIT | c.DEPTH_BUFFER_BIT);
                   },
                   Qe: function () {
                    console.log("--------Lb :Qe été exécutée.");
                     c.clear(c.COLOR_BUFFER_BIT);
                   },
                   th: function () {
                    console.log("--------Lb :th été exécutée.");
                     c.clear(c.DEPTH_BUFFER_BIT);
                   },
                   Wc: function () {
                    console.log("--------Lb :Wc été exécutée.");
                     c.viewport(0, 0, q, x);
                   },
                   u: function () {
                    console.log("--------Lb :u été exécutée.");
                     k !== p.ma && (c.bindFramebuffer(b, I), (p.ma = k));
                   },
                   rtt: function (F) {
                    console.log("--------Lb :rtt été exécutée.");
                     m = F;
                     p.ma !== k &&
                   ...
                   aa: function () {
                    console.log("--------Lb :aa été exécutée.");
                     c.bindFramebuffer(b, null);
                     p.ma = -1;
                   },
                   resize: function (F, L) {
                    console.log("--------Lb :resize été exécutée.");
                     q = F;
                     x = L;
                     u &&
                       (c.bindRenderbuffer(c.RENDERBUFFER, u),
                   ...
                   remove: function () {
                    console.log("--------Lb :remove été exécutée.");
                     I === a ||
                       A ||
               ...
               reset: function () {
                console.log("--------Lb :reset été exécutée.");
                 p.ma = -2;
               },
               ba: function () {
                console.log("--------Lb :ba été exécutée.");
         ...
         Ia = (function () {
          console.log("--------Lb :Ia: été exécutée.");
           function a() {
            console.log("Ia:La fonction a() a été exécutée.");
             h = "undefined" === typeof mb ? ha : mb;
             m = !0;
           }
           function b(e, n, z) {
            console.log("--------Lb :Ia: b(e n z)été exécutée.");
           ...
           function f(e) {
            console.log("Lb: La fonction f(e) a été exécutée.");
             if (0 === g.wb.length) {
           ...
           var h = null,
             ...
             G = {
               ...
               P: function () {
                console.log("--------Lb :P: été exécutée.");
                 m || a();
                 return h.P();
               },
               $: function () {
                console.log("--------Lb :$: été exécutée.");
                 m || a();
                 return h.$();
               },
               na: function () {
                console.log("--------Lb :na: été exécutée.");
                 m || a();
                 return h.na();
               },
               Mh: function (e) {
               ...
               pf: function (e) {
                console.log("--------Lb :pf: été exécutée.");
                 var n = G.wd(e);
               ...
               Yl: function () {
                console.log("--------Lb :Yl: été exécutée.");
                 return k || c.RGBA32F || c.RGBA;
               },
               Zl: function () {
                console.log("--------Lb :Zl: été exécutée.");
         ...
         Hb = (function () {
           function a(e, n, z, P) {
            console.log("La fonction a(e, n, z, P) a été exécutée.");
             g.texParameteri(
               g.TEXTURE_2D,
           ...
           function p() {
            console.log("La fonction p(e) a été exécutée.")
         ...
         $d = {
           instance: function (a, b) {
            console.log("-----------------------------------instance a été exécutée.------------------------------------");
         ...
         Xd = {
           instance: function (a) {
             function b(x) {
              console.log("La fonction b(x) a été exécutée.");
               return ba.instance({
                 isFloat: x,
                 width: d.da,
                 isPot: !1,
         ...
         Db = (function () {
           ...
           function m(B, E, M) {
            console.log("La fonction m(B, E, M) a été exécutée.");
             E = B.createShader(E);
             B.shaderSource(E, M);
             B.compileShader(E);
             return E;
           ...
           function x(B) {
            console.log("La fonction x(B) a été exécutée.");
             var E = e.Xa,
               M = e.Fd,
               t = e.Gd;
             t = e.Yb
         ...
         Eb = (function () {
           function a(T) {
            console.log("La fonction a(T) a été exécutée.");
             switch (n) {
               case e.movePinch:
                 var ta = -T.deltaY;
           ...
           function b(T) {
            console.log("La fonction b(T) a été exécutée.");
             if (-1 !== z)
               switch (n) {
                 case e.swipe:
                   if (1 !== z) break;
           ...
           function f(T) {
            console.log("La fonction f(T) a été exécutée.");
             T.preventDefault();
             if (-1 !== z)
               switch (n) {
                 case e.swipe:
           ...
           function w() {
            console.log(" dddd La fonction w() a été exécutée.");
           ...
           function h() {
            console.log("La fonction h() a été exécutée.");
           ...
           function q(T) {
            console.log("La fonction q(T) a été exécutée.");
             I(T, qa, 0);
             I(T, oa, 1);
             return Math.sqrt(qa[0] * qa[0] + oa[0] * oa[0]);
           }
           function x(T, ta) {
            console.log("La fonction x(T, ta) a été exécutée.");
             void 0 !== T.changedTouches || void 0 !== T.touches
               ? I(T, ta, 0)
           ...
           function y(T) {
            console.log("La fonction y(T) a été exécutée.");
             T.forEach(function (ta) {
               A(ta.type, ta.sb);
             });
           }
           function A(T, ta) {
            console.log("La fonction A(T, ta) a été exécutée.");
           ...
           function k(T, ta, Ha, bb) {
            console.log("La fonction k(T, ta, Ha, bb) a été exécutée.");
             D[T].forEach(function (Da) {
               Da.sb(ta, Ha, bb);
             });
           }
           function g(T) {
            console.log("La fonction g(T) a été exécutée.");
       ...
       var C = (function () {
           function a(e, n, z) {
            console.log("La fonction a(e, n, z) a été exécutée.");
             n = e.createShader(n);
             e.shaderSource(n, z);
             e.compileShader(n);
           ...
           function b(e, n) {
            console.log("La fonction c(e, n) a été exécutée.");
           ...
           function d(e) {
            console.log("La fonction d(e) a été exécutée.");
           ...
           function l(e, n) {
            console.log("La fonction l(e,n) a été exécutée.");
             if (n.pi) return !1;
             var z = ha.na();
           ...
           function p(e, n) {
            console.log("La fonction p(e, n) a été exécutée.");
             l(e, n);
             n.set();
             g = -1;
             return n;
         ...
         $a = (function () {
           var a = {},
             ...
             Qa = {
               ...
               cb: function (H) {
                 function r() {
                  console.log("La fonction r() a été exécutée.");
                   q && za.mb.toggle(!1);
         ...
         Ba = (function () {
           function a() {
            console.log("Ba:La fonction a() a été exécutée.");
             h.forEach(function (r) {
               r.El(v);
             });
           }
           function b() {
            console.log("Ba:La fonction b() a été exécutée.");
             h.forEach(function (r) {
               r.sd(v);
             });
           }
           function d() {
            console.log("Ba:La fonction d() a été exécutée.");
             h.forEach(function (r) {
               r.Cl(v);
             });
           }
           function f() {
            console.log("Ba:La fonction f() a été exécutée.");
             h.forEach(function (r) {
               r.td(v);
             });
           }
           function l() {
            console.log("Ba:La fonction l() a été exécutée.");
             v
               ? $a.Dl(h)
               : h.forEach(function (r) {
                   r.zl();
           ...
           function p() {
            console.log("Ba:La fonction p() a été exécutée.");
             E && clearTimeout(E);
           ...
           function w(r) {
            console.log("Ba:La fonction w(r) a été exécutée.");
             r();
           }
           var h = [],
             m = [],
         ...
         ha = (function () {
           ...
           var b = null,
             ...
             A = {
               ...
               Xg: function (k) {
                console.log("-------------------------------Xg a été exécutée.------------------------");
                 m = k;
                 a();
               },
               Ma: function (k, g) {
                console.log("-------------------------------Ma a été exécutée.------------------------");
                 b.addEventListener(k, g, !1);
               },
               pd: function () {
                console.log("-------------------------------pd a été exécutée.------------------------");
                 l = -1;
                 return !1;
               },
               sh: function () {
                console.log("-------------------------------sh a été exécutée.------------------------");
                 return 0 <= l;
               },
               vq: function () {console.log("-------------------------------vq a été exécutée.------------------------");},
               Gq: function () {console.log("-------------------------------Gq a été exécutée.------------------------");},
               Tq: function () {
                console.log("-------------------------------Tq a été exécutée.------------------------");
         ...
         Yb = (function () {
           function a(M) {
            console.log("Yb:La fonction a(M) a été exécutée.");
           ...
           function b(M) {
            console.log("Yb:La fonction b(M) a été exécutée.");
             -1 !== h &&
               ((F = g = 0),
               w(),
           ...
           function d() {
            console.log("Yb:La fonction d(M) a été exécutée.");
             D += g;
             G += F;
           ...
           function f(M) {
            ("Yb:La fonction f(M) a été exécutée.");
             if (0 === h || -1 === h) return !1;
           ...
           function l() {
            console.log("Yb:La fonction l() a été exécutée.");
             0 !== h &&
               -1 !== h &&
               ((0 === g && 0 === F) || 1 !== h || !z
                 ? Ba.va()
           ...
           function p(M) {
            console.log("Yb:La fonction p(M) a été exécutée.");
             if (2 !== h && -1 !== h) {
               F = g = 0;
               w();
               Ba.wake();
           ...
           function w() {
            console.log("Yb:La fonction w() a été exécutée.");
         ...
         Kc = (function () {
           ...
           return {
             instance: function (b) {
               ...
               function f(r) {
                console.log("Yb:La fonction f(r) a été exécutée.");
                 L.Na(r.n, r.offset);
               }
               function l(r, N) {
                console.log("Yb:La fonction l(r,N) a été exécutée.");
                 U[N] &&
                   (C.set(U[N].mm()),
                   L.bind(!1),
               ...
               function p(r, N) {
                console.log("Yb:La fonction p(r, N) a été exécutée.");
                 U[N] &&
                   (C.set(U[N].nm()),
                   L.bind(!1),
                   O ? (C.Ra(), C.uj()) : (C.bb(), C.vj()),
               ...
               function w(r, N) {
                console.log("Yb:La fonction w(r, N) a été exécutée.");
                 ka && U[N] && (U[N].vl(), L.Na(r.n, r.offset));
               }
               function h(r, N) {
                console.log("Yb:La fonction h(r, N) a été exécutée.");
                 ka && U[N] && (U[N].xl(O), L.Na(r.n, r.offset));
               }
               function m(r, N) {
                console.log("Yb:La fonction m(r, N) a été exécutée.");
                 U[N] && (C.set(U[N].im()), U[N].Hh(), L.Na(r.n, r.offset));
               }
               function q(r, N) {
                console.log("Yb:La fonction q(r, N) a été exécutée.");
                 U[N] &&
                   (C.set(U[N].jm()), H.Dc(), U[N].Hh(), L.Na(r.n, r.offset));
               }
               function x(r, N) {
                console.log("Yb:La fonction x(r, N) a été exécutée.");
                 U[N] &&
                   (C.set(U[N].km()),
               ...
               function I(r, N) {
                console.log("Yb:La fonction I(r, N) a été exécutée.");
                 if (U[N]) {
                   var ca = U[N].lm();
                   C.set(ca);
               ...
               function u(r, N) {
                console.log("Yb:La fonction u(r, N) a été exécutée.");
       ...
       var Uc = (function () {
           function a(w) {
            console.log("Yb:La fonction a(w) a été exécutée.");
             var h = w.split(":").shift();
           ...
           function b(w, h) {
            console.log("Yb:La fonction b(w, h) a été exécutée.");
           ...
           return {
             ...
             instance: function (w) {
               function h() {
                console.log("Yb:La fonction H() a été exécutée.");
               ...
               function m() {
                console.log("Yb:La fonction m() a été exécutée.");
               ...
               function q() {
                console.log("Yb:La fonction q() a été exécutée.");
                 return new Promise(function (v) {
               ...
               function x() {
                console.log("Yb:La fonction x() a été exécutée.");
                 return new Promise(function (v) {
               ...
               function I(v, Q) {
                console.log("Yb:La fonction I(I, Q) a été exécutée.");
                 h();
       ...
       za.ia = (function () {
         ...
         var d = !1,
           ...
           M = {
             ...
             fb: function (t, v) {
              console.log("-----------------------------------fb function(t,v) catch a été exécutée.---------------");
             ...
             zg: function (t) {
              console.log("-----------------------------------zg catch a été exécutée.---------------");
               a([{ type: "1f", name: "u81", value: t }]);
               C.M();
             },
             Gb: function (t) {
              console.log("-----------------------------------Gb catch a été exécutée.---------------");
               t && (z = t);
               M.Ac();
             },
             Ag: function (t, v) {
              console.log("-----------------------------------Ag catch a été exécutée.---------------");
               L[0].value = 1 - t;
               a(L);
               a(v);
             },
             I: function () {},
             A: function () {
              console.log("-----------------------------------I catch a été exécutée.---------------");
       ...
       za.ua = (function () {
         var a = !1,
           ...
           q = {
             Sc: function () {
              console.log("-----------------------------------Sc catch a été exécutée.---------------");
               C.oa("s127", {
                 name: "_",
             ...
             m: function (x) {
              console.log("-----------------------------------m function(x) catch a été exécutée.---------------");
               if (a) {
             ...
             ec: function (x) {
              console.log("-----------------------------------ec catch a été exécutée.---------------");
               b = x;
             },
             dc: function (x) {
              console.log("Lb: -----------------------------------dc catch a été exécutée.---------------");
               w = x;
               w.zc(q.Te);
             },
             Te: function () {
              console.log("Lb: -----------------------------------Te catch a été exécutée.---------------");
             ...
             W: function () {
              console.log("Lb: -----------------------------------W catch a été exécutée.---------------");
               C.set("s128");
               b.h(1);
               h.h(2);
               w.Dh();
             ...
             eb: function (x) {
              console.log("-----------------------------------eb catch a été exécutée.---------------");
               C.j("s128", [{ type: "3f", name: "u146", value: x }]);
               C.M();
             },
             fb: function (x) {
              console.log("Lb: -----------------------------------fb catch a été exécutée.---------------");
               C.j("s128", [{ type: "1f", name: "u147", value: x }]);
               C.M();
             },
             zg: function (x) {
              console.log("Lb: -----------------------------------zg catch a été exécutée.---------------");
               C.j("s128", [{ type: "1f", name: "u81", value: x }]);
               C.M();
             },
             Co: function (x) {
              console.log("Lb: -----------------------------------Co catch a été exécutée.---------------");
               d = x;
               q.Te();
               C.M();
               Ba.animate(Date.now());
             ...
             Gb: function (x) {
              console.log("Lb: -----------------------------------Gb catch a été exécutée.---------------");
               x && (w = x);
               q.Te();
             },
             Ag: function (x, I) {
              console.log("Lb:-----------------------------------Ag catch a été exécutée.---------------");
               p.u171 = 1 - x;
               C.j("s128", p);
               C.j("s128", I);
             },
       ...
       za.rc = (function () {
        console.log("lb:------------ za.rc a été exécutée.");
         var a = [0, -0.5],
           b = !1,
           d = !1,
           f = null,
         ...
         return {
           Sc: function () {
            console.log("Lb:-----------------------------------sc catch a été exécutée.---------------");
             C.oa("s129", {
               name: "_",
           ...
           m: function (x) {
            console.log("Lb: -----------------------------------m catch a été exécutée.---------------");
             b &&
               ((h = ba.instance({
                 isFloat: !1,
                 isPot: !0,
           ...
           ec: function (x) {
            console.log("Lb: -----------------------------------ec catch a été exécutée.---------------");
             l = x;
           },
           ug: function (x, I) {
            console.log("Lb: -----------------------------------ug catch a été exécutée.---------------");
             var u = {
               isFloat: !1,
               isPot: !1,
               isMipmap: !1,
       ...
       var fd = (function () {
        console.log("Lb: ----------var fd catch a été exécutée.---------------");
         var a = {
           instance: function (b) {
            console.log("Lb:-----------------------------------instance catch a été exécutée.---------------");
             var d = b.Zf,
               f = b.Uf,
               l = b.nd,
             ...
             return {
               ci: function () {
                console.log("Lb: -----------------------------------ci catch a été exécutée.---------------");
                 return w;
               },
               Vh: function () {
                console.log("Lb: -----------------------------------Vh catch a été exécutée.---------------");
                 return p;
               },
               set: function () {
                console.log("Lb: -----------------------------------set catch a été exécutée.---------------");
                 m = gb.em();
                 gb.yj(h);
                 gb.ue();
                 gb.ve();
               ...
               cc: function () {
                console.log("Lb: ----------------------------------cc catch a été exécutée.---------------");
                 return {
                   modelURL: d,
                   materialsURLs: f,
                   background: p.cc(!1),
               ...
               hm: function () {
                console.log("Lb: ----------------------------------hm catch a été exécutée.---------------");
                 return l.cc(!1);
               },
               xp: function (q) {
                console.log("--Lb: -----------------------------xp catch a été exécutée.---------------");
                 p.h(q);
               },
               I: function () {
                console.log("Lb: ---------------------------I catch a été exécutée.---------------");
                 l.remove();
                 w.remove();
           ...
           Zc: function (b, d, f) {
            console.log("Lb: ------------Zc catch a été exécutée.---------------");
             function l() {
               if (3 === ++m && d) {
                 var q = a.instance({
                   Zf: b.modelURL,
     ...
     wd = (function () {
      console.log("-------------------------------wd a été exécutée.------------------------");
       ...
       var V = function (ua, Ga) {
        console.log("wb:------------ var V a été exécutée.");
         function Ka() {
          console.log("wb:------------ Ka a été exécutée.");
           var La = [];
           ...
           var kb, zb;
           this.call = function () {
            console.log("wb:------------ this.call a été exécutée.");
             kb = 0;
             for (zb = La.length; kb < zb; kb++) La[kb].call();
           };
           this.remove = function (Gb) {
            console.log("wb:------------ this.remove a été exécutée.");
             var Pb = [];
             kb = 0;
           ...
           this.length = function () {
            console.log("wb:------------ this.length a été exécutée.");
             return La.length;
           };
         }
         function vb(La, kb) {
          console.log("wb:La fonction vb(La, kb) a été exécutée.");
           if (La)
             if (La.resizedAttached) La.resizedAttached.add(kb);
               ...
               var zb = La.resizeSensor.childNodes[0],
                 ...
                 wc = La.offsetHeight,
                 xc = function () {
                  console.log("--------wb : xc été exécutée.");
               ...
               xc();
               var yc = function () {
                console.log("--------wb var yc été exécutée.");
                 Mb = 0;
                 ac &&
                   ((mc = lc),
                   (wc = Nb),
         ...
         this.detach = function (La) {
          console.log("wb: -----------------------------------this.detach catch a été exécutée.---------------");
           V.detach(ua, La);
         };
       };
       V.detach = function (ua, Ga) {
        console.log("wb: ----------------------------------V.detach catch a été exécutée.---------------");
         S(ua, function (Ka) {
           if (Ka) {
             if (
               Ka.resizedAttached &&
    ...
    Kb =  {
     ...
     wb = {
       start: function (S) {
        console.log("wb -------------------------start a été exécutée.---------------------------");
         var V = Object.assign(
           {
             settings: null,
             NNCPath: null,
         ...
         console.log("Settings copied successfully: V", V);
         return new Promise(function (ua, Ga) {
           if (Sa.mode !== ob.notLoaded)
             ...
             console.log("Settings copied successfully:", Kb);
             ...
             Wa.init2({
              ...
              console.log("wb:-----------------------------------start catch a été exécutée.---------------");
               Sa.isRT = !1;
               sb(vb || "NO_ERROR_LABEL");
               Ga();
             });
             Wa.onHalfLoad(function () {
              console.log("wb: ---------------------------onHalfLoad a été exécutée.---------------");
       ...
       destroy: function () {
        console.log("wb: ------------------------destroy a été exécutée.------------------------");
       ...
       preFetch: function (S) {
        console.log("wb: ------------------------preFetch a été exécutée.------------------------");
       ...
       pause: function (S) {
        console.log("wb: ------------------------pause a été exécutée.------------------------");
       ...
       resume: function (S) {
        console.log("wb: ------------------------resume a été exécutée.------------------------");
         if (!Sa.isRT || !Wa.ready) return Promise.reject();
         Sa.mode = ob.realtime;
         Ic();
       ...
       set_videoRotation: function (S) {
        console.log("wb: ------------------------set_videoRotation a été exécutée.------------------------");
         Sa.isRT && Wa.set_videoRotation(S);
       },
       set_videoSizes: function (S, V, ua, Ga, Ka, vb) {
        console.log("wb: ------------------------set_videoSizes a été exécutée.----------------");
         Sa.isRT && Wa.set_videoSizes(S, V, ua, Ga, Ka, vb);
       },
       resize: function () {
        console.log("wb: ------------------resize a été exécutée.-----------------------");
         hc && clearTimeout(hc);
       ...
       load_glassesDB: function (S, V, ua) {
        console.log("----ua----",ua);
        console.log("Wb:--------------------load_glassesDB a été exécutée.-------------------");
         if (Sa.mode === ob.notLoaded)
       ...
       exit_adjustMode: Fb,
       set_LUT: function (S) {
        console.log("set_LUT a été exécutée.");
         return Wa && Wa.ready
           ? Wa.set_LUT(S || null)
